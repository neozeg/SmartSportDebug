...
public class BluetoothLeService extends Service {
    ...
    private void broacastUpdate(final String action, int status){
    	final Intent intent = new Intent(action);
    ...
    public boolean setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        return result = mBluetoothGatt.writeDescriptor(descriptor);
    ...
    public boolean sendCharacteristicData(BluetoothGattCharacteristic characteristic,byte[] data){
    	boolean result = false;
    	if(mBluetoothAdapter == null || mBluetoothGatt == null){
    		Log.w(TAG, "BluetoothAdapter not initialized");
    		return result;
